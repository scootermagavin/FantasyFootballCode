...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan  1 14:26:47 2022
...
# requests in python are handled by library requests, this gets the server response
resp = requests.get(full_mookie_url)

# then to turn it into json file using the server response object
