...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan  2 16:24:01 2022
...
DATA_DIR = '/Users/scotthoran/OneDrive/Documents/Python_with_Baseball/ltcwbb-files-0.6.1/data/100-game-sample'

dfp = pd.read_csv(path.join(DATA_DIR, 'pitches.csv'))
dfb = pd.read_csv(path.join(DATA_DIR, 'atbats.csv'))
